package com.example.alarmclockdemo.view;
...
public class SwitchButton extends CompoundButton {
	...
	private void init(AttributeSet attrs) {
		...
		if (ta != null) {
			...
			thumbRadius = ta.getDimension(R.styleable.SwitchButton_sbThumbRadius, Math.min(thumbWidth, thumbHeight) / 2.f);
			backRadius = ta.getDimension(R.styleable.SwitchButton_sbBackRadius, thumbRadius + density * 2f);
			...
			backMeasureRatio = ta.getFloat(R.styleable.SwitchButton_sbBackMeasureRatio, backMeasureRatio);
			...
			textMarginH = ta.getDimension(R.styleable.SwitchButton_sbTextMarginH, textMarginH);
			autoAdjustTextPosition = ta.getBoolean(R.styleable.SwitchButton_sbAutoAdjustTextPosition, autoAdjustTextPosition);
			ta.recycle();
		}
